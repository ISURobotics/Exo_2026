...
void setup(void) {
  ...
  pinMode(IMU_PWR1, OUTPUT);
  pinMode(IMU_PWR2, OUTPUT);
  pinMode(IMU_PWR3, OUTPUT);

  digitalWrite(IMU_PWR1, HIGH);  // turn IMU ON
  digitalWrite(IMU_PWR2, HIGH);
  digitalWrite(IMU_PWR3, HIGH);
  delay(100);
  ...
  digitalWrite(IMU_PWR1, LOW);
  digitalWrite(IMU_PWR2, LOW);
  digitalWrite(IMU_PWR3, LOW);
}
